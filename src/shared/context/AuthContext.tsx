 ...
 * 현재는 localStorage 키로 가드만 동작; 추후 백엔드 Auth API 연동 예정.
...
/** Mock/Dev용 딜러 ID 플레이스홀더. API 전환 시 JWT sub 또는 uid로 교체 */
 ...
 * @description 인증 상태를 localStorage에 동기화. 추후 백엔드 Auth API 연동 예정.
 */
