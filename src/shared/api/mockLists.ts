...
export interface MockVehicleShape {
  ...
  updatedAt: ReturnType<typeof ts>;
}
...
export const MOCK_VEHICLE_LIST: MockVehicleShape[] = [
  MOCK_VEHICLES_ALL[0], MOCK_VEHICLES_ALL[1], MOCK_VEHICLES_ALL[2], MOCK_VEHICLES_ALL[3], MOCK_VEHICLES_ALL[6], MOCK_VEHICLES_ALL[8],
];
