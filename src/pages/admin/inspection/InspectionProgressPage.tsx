/**
 * InspectionProgressPage (Vercel 배포용)
 * 검차 진행 상황 (Figma §3.6 CTA_2 검차 플로우)
 * nodeId: 1121-5308·1425-10137 매칭중, 1193-8343·1425-10813 이동중
 */
...
import type { TimestampLike } from '@/shared/lib/timestamp';

type ProgressStage = 'matching' | 'en_route' | 'complete';

const STEPPER_LABELS = ['검차자 매칭중', '검차자 매칭 완료', '검차중', '검차완료'];

const FALLBACK_TIMESTAMP: TimestampLike = { seconds: 0, toDate: () => new Date() };
