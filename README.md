...
**대상**:알고리즘·처리 과정·입출력·IPOE·기대효과를 세세히 설명함.
...
**IPOE**는 **I·P·O·E**의 약자로, 프로젝트 문서에서 정의한 **기능별 4블록** 명세 형식입니다.
...
# JSON 리포트 저장
figma-audit --node 794-3704 --output report_794-3704.json
```
